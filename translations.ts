...
export const translations: Record<string, Translation> = {
    bn: {
        ...
        resumeReading: 'আগে যেখানে পড়া ছেড়েছেন সেখান থেকে শুরু করবেন?',
        yes: 'হ্যাঁ',
        no: 'না',
    },
    en: {
        ...
        resumeReading: 'Continue from where you left off?',
        yes: 'Yes',
        no: 'No',
    },
    hi: {
        ...
        resumeReading: 'जहाँ आपने छोड़ा था वहीं से जारी रखें?',
        yes: 'हाँ',
        no: 'नहीं',
    },
    or: {
